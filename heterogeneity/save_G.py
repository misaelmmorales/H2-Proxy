...
nx, ny, nz = 256, 256, 1
my_dir   = os.getcwd()
data_dir = '/project/mfr/shaowen/8.HETE_2D_Gaussian_VaryGeometry/samples_G/RESULTS/FUNRST'
    ...
    for file in funrst_files:
        ...
        with open(file, 'r') as f:
            ...
            while line:
                ...
                line = next(lines, None)
        savemat('/project/MFR2/misael/h2datag/{}.mat'.format(os.path.splitext(file)[0]), arrays_dict)
    os.chdir('../')
os.chdir(my_dir)